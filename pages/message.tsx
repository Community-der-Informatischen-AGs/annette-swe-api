  ...
  return <>
    ...
    <main className={styles.main}>
      ...
      <section className={styles.section}>
        ...
        <p>Es ist uns, den Entwicklern bei der Annette-Entwickelt-Software-AG eine Freude, euch Annette-App 4.0 zu präsentieren. Seit Anfang des Jahres 2022 arbeiten wir zusammen fleißig an diversen Software-Projekten der Schule, inklusive der Annette-App.</p>
